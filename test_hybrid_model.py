...
try:
    ...
    print(f"{'Sample':<10} {'IsoForest':<12} {'RandomForest':<15} {'Hybrid Score':<15} {'Prediction':<12}")
    print("-" * 70)
    ...
    for i in range(5):
        ...
        print(f"{i+1:<10} {iso_s:<12} {rf_s:<15} {hybrid_s:<15} {pred:<12}")
    ...
    all_hybrid_pred = [1 if score > 0.5 else 0 for score in all_hybrid_scores]
    ...
    print("\n" + "="*70)
    print("✓ HYBRID MODEL TESTING COMPLETED SUCCESSFULLY!")
    print("="*70)
